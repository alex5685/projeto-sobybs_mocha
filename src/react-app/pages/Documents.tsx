...
import { Upload, FileText, Image, Download, Trash2, ArrowLeft, Loader2, AlertCircle } from "lucide-react";
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-lg text-gray-600">
                Gerencie fotos e documentos da sua conta
              </p>
            </div>
            {hasPermission && (
          ...
          {!hasPermission && (
            <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-xl flex items-start mb-6">
              ...
              <div className="text-yellow-800 text-sm">
                ...
                <p>Apenas perfis Comprador, Vendedor, Híbrido e Admin podem gerenciar documentos.</p>
              </div>
            </div>
          )}
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1 min-w-0">
                      ...
                      <h3 className="font-semibold text-gray-900 mt-3 mb-1 truncate" title={doc.file_name}>
                        {doc.file_name}
                      </h3>
