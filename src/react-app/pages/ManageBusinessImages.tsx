...
export default function ManageBusinessImages() {
  ...
  const fetchBusinessAndImages = async () => {
    setIsLoading(true);
    try {
  ...
  const handleFileSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Check image limit
    if (images.length >= 7) {
      alert("Limite máximo de 7 fotos atingido");
      return;
    }
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="text-sm text-gray-600">
              <span className={images.length >= 7 ? "text-red-600 font-semibold" : ""}>
                {images.length}/7 fotos
              </span>
            </div>
          </div>
          ...
          {images.length >= 7 ? (
            <div className="border-2 border-gray-300 rounded-xl p-8 text-center bg-gray-50">
              ...
              <p className="text-lg font-semibold text-gray-700 mb-2">
                Limite máximo de 7 fotos atingido
              </p>
              ...
              {images.map((image) => (
                ...
                >
                  ...
                  <div className="p-3 bg-white">
                    ...
                    <p className="text-xs text-gray-400 mt-1">Key: {image.storage_key}</p>
                  </div>
                </div>
              ))}
            </div>
