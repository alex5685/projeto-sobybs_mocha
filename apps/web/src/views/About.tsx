    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {data?.institutional_founder_name && (
          <section className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-foreground mb-4">Founder</h2>
            </div>
            <div className="bg-card rounded-2xl p-12 shadow-lg border border-border max-w-4xl mx-auto">
              <div className="flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="flex-1">
                  <h3 className="text-3xl font-bold text-foreground mb-4 text-center md:text-left">
                    {data.institutional_founder_name}
                  </h3>
                  <p className="text-muted-foreground leading-relaxed whitespace-pre-wrap text-justify">
        ...
        {teamMembers.length > 0 && (
          <section className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-foreground mb-4">Nosso Time</h2>
        ...
        {jobOpenings.length > 0 && (
          <section className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-foreground mb-4">Faça parte do Time!</h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              {jobOpenings.map((job) => (
                <div
                  key={job.id}
                  className="bg-card rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow border border-border cursor-pointer"
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-100">
              ...
              <h4 className="text-lg font-bold text-foreground mb-2">Valuation com IA</h4>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-100">
              ...
              <h4 className="text-lg font-bold text-foreground mb-2">Suporte Jurídico</h4>
              <p className="text-muted-foreground text-sm">
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-100">
              ...
              <h4 className="text-lg font-bold text-foreground mb-2">Suporte Contábil</h4>
              <p className="text-muted-foreground text-sm">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-6 border border-orange-100">
              ...
              <h4 className="text-lg font-bold text-foreground mb-2">Marketplace Ativo</h4>
              <p className="text-muted-foreground text-sm">
