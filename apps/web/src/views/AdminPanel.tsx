...
export default function AdminPanel() {
  ...
  const loadData = async () => {
    try {
      setIsLoading(true);
      const [settingsRes, statsRes, teamRes, jobsRes, appsRes, servicesRes, faqsRes] =
        await Promise.all([
              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mt-6">
                  ...
                  <div className="text-sm text-blue-800 space-y-2">
                    <p>
                      <strong>Receita Recorrente:</strong> Planos mensais de consultoria (Bronze,
                      Silver, Gold) que cobrem captação e garimpagem de interessados
                    </p>
                    <p>
                      <strong>Receita Variável:</strong> Comissões sobre o valor de fechamento das
                      vendas de empresas
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-gray-600">
                      Configure os serviços incluídos em cada plano de consultoria (Bronze, Silver e
                      Gold).
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
                  ...
                  <div className="text-sm text-blue-800 space-y-2">
                    <p>
                      <strong>Ordem de Exibição:</strong> Números menores aparecem primeiro na lista
                    </p>
                    <p>
                      <strong>Status:</strong> Serviços inativos não aparecem na página pública de
                      planos
                    </p>
                    <p>
                      <strong>Descrição:</strong> Seja claro e específico sobre o que cada serviço
                      oferece
                    </p>
                  </div>
                </div>
                        ...
                        <input
                          ...
                          placeholder={
                            setting.setting_key.includes('photo')
                              ? 'URL da foto (use Settings → Assets para upload)'
                              : ''
                          }
                        />
                      )}
              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mt-6">
                  ...
                  <div className="text-sm text-blue-800 space-y-2">
                    ...
                    <p>
                      <strong>Redes Sociais:</strong> Use URLs completas para melhor funcionamento
                      dos links
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
                  ...
                  <div className="text-sm text-blue-800 space-y-2">
                    ...
                    <p>
                      <strong>Respostas Concisas:</strong> Mantenha as respostas claras e objetivas
                    </p>
                  </div>
                </div>
              </div>
                      ...
                      <div className="flex justify-between items-start mb-4">
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap gap-2 mt-2 text-sm text-gray-600">
                            {job.department && (
                              <span className="px-2 py-1 bg-blue-50 rounded">{job.department}</span>
                            )}
                            {job.location && (
                              <span className="px-2 py-1 bg-purple-50 rounded">{job.location}</span>
                            )}
                            {job.employment_type && (
    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl max-w-2xl w-full p-8 max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          {formData.plan_name && (
            <div
              className={`bg-gradient-to-r ${planColors[formData.plan_name as keyof typeof planColors]} rounded-xl p-4`}
            >
              <p className="text-white text-sm font-semibold mb-2">
                Preview do Plano{' '}
                {formData.plan_name.charAt(0).toUpperCase() + formData.plan_name.slice(1)}
              </p>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-3">
                <p className="text-white text-sm">
                  {formData.service_description || 'Digite uma descrição para visualizar'}
                </p>
              </div>
            </div>
          )}
