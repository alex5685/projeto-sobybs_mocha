  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        // Pass ?refresh=1 when coming from registration so the AI re-runs with the latest data
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Análise com IA e pesquisa de mercado • Última atualização: {lastUpdatedStr}
          </p>
        </div>
